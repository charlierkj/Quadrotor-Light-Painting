...
if __name__ == "__main__":
  ...
  t1 = np.arange(0, traj1.duration, 0.001)
  ...
  t_wps2 = []
  t_wps3 = []
  wps1.append(traj1.eval(0).snap)
  wps2.append(traj2.eval(0).snap)
  wps3.append(traj3.eval(0).snap)
  t_wps1.append(0)
  t_wps2.append(0)
  t_wps3.append(0)
  t_1 = 0.0
  ...
  for i in range(0, len(traj1.polynomials)):
    ...
    t_wps2.append(t_2)
    t_wps3.append(t_3)
    wps1.append(traj1.eval(math.floor(t_1*1000)/1000).snap)
    wps2.append(traj2.eval(math.floor(t_2*1000)/1000).snap)
    wps3.append(traj3.eval(math.floor(t_3*1000)/1000).snap)
  wps1 = np.array(wps1)
  ...
  ax = plt.subplot(gs[3, 1]) # row 3
  ax.plot(t2, snap2)
  ax.scatter(t_wps2, np.linalg.norm(wps2[:,0:3], axis=1), c='r')
  ...
  ax = plt.subplot(gs[3, 2]) # row 3
  ax.plot(t3, snap3)
  ax.scatter(t_wps3, np.linalg.norm(wps3[:,0:3], axis=1), c='r')
